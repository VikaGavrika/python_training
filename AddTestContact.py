...
class AddTestContact(unittest.TestCase):
    ...
    def test_add_test_contact(self):
        ...
        self.create_contact(wd, firstname="Volodya", middlename="Petrovich", lastname="Volkov", nickname="Volk", tittle="Pik", company="Puki", address="gorod", home="9-999-99",
                            mobile="9-999-999-99-99", work="9-99", fax="9", email="volkov@volkov", email2="volkov2@volkov", email3="volkov3@volkov",
    ...
    def create_contact(self, wd, firstname, middlename, lastname, nickname, tittle, company, address, home, mobile,
        ...
        wd.find_element_by_name("title").send_keys("%s" % tittle)
